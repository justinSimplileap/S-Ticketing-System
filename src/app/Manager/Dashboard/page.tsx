  ...
  useEffect(() => {
    const fetchTickets = async () => {
      try {
        ...
        const response = await axios.get<{ body: Ticket[] }>(`${base_url}/allTicketsManager/`, {
          headers: {
    ...
    <div>
          ...
          <div className="grid grid-cols-4 gap-4 pl-5 pr-5">
            <div className="bg-[#F7F7F7] p-8 rounded-md mb-7">
              <div className="grid grid-cols-2 pb-10">
                ...
                <div className="flex justify-end items-end">
                  <Link href={{ pathname: '/team/TicketManagement' }}>
                    <div className="flex justify-end items-end">
            ...
            <div className="bg-[#F7F7F7] p-8 rounded-md mb-7">
              <div className="grid grid-cols-2 pb-10">
                ...
                <div className="flex justify-end items-end">
                  <Link href={{ pathname: '/team/TicketManagement', query: { priority: 'High' } }}>
                    <div className="flex justify-end items-end">
                      <Image src={Arrow} alt="Arrow" width={30} />
                    </div>
                  </Link>
            ...
            <div className="bg-[#F7F7F7] p-8 rounded-md mb-7">
              <div className="grid grid-cols-2 pb-10">
                ...
                <div className="flex justify-end items-end">
                  <Link href={{ pathname: '/team/TicketManagement', query: { status: 'Active' } }}>
                    <div className="flex justify-end items-end">
                      <Image src={Arrow} alt="Arrow" width={30} />
                    </div>
                  </Link>
            ...
            <div className="bg-[#F7F7F7] p-8 rounded-md mb-7">
              <div className="grid grid-cols-2 pb-10">
                ...
                <div className="flex justify-end items-end">
                  <Link href={{ pathname: '/team/TicketManagement', query: { status: 'Closed' } }}>
                    <div className="flex justify-end items-end">
                      <Image src={Arrow} alt="Arrow" width={30} />
                    </div>
                  </Link>
      ...
      <div className='p-6'>
        <div className='bg-[#FFFFFF] shadow-md w-1/2 p-3 rounded-lg font-bold'>
          ...
          <div className='mt-2 '>
            <Image src={Rectangle} alt="notify" />
          </div>
        </div>
      </div>
      <div className='p-6'>
        <TableThree tickets={tickets} />
      </div>
    </div>
  );
};
