...
const WorkDomainInput: React.FC<WorkDomainInputProps> = ({ register, errors }) => {
  ...
  return (
    ...
    <div className="w-full px-2">
      <label htmlFor="workDomain" className="block mt-6 font-lato text-sm">
        Work Domain
      </label>
    ...
    <div className="p-8">
      ...
      <div className="flex py-5 items-center">
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          ...
          <div>
            <label htmlFor="companyName" className="block text-sm text-[#232323] font-lato">
          ...
          <div className="col-span-2">
            <label htmlFor="companyUrl" className="block text-sm text-[#232323] font-lato">
              Company URL
            </label>
            <input
              id="companyUrl"
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="companyAddress" className="block text-sm text-[#232323] font-lato">
            Company Address
          </label>
          <input
            id="companyAddress"
        ...
        <div>
          <label htmlFor="city" className="block text-sm text-[#232323] font-lato">
            City
          </label>
          <input
            id="city"
        ...
        <div>
          <label htmlFor="country" className="block text-sm text-[#232323] font-lato">
            Country
          </label>
          <input
            id="country"
        ...
        <div>
          <label htmlFor="postalCode" className="block text-sm text-[#232323] font-lato">
            Postal Code
          </label>
          <input
            id="postalCode"
        ...
        <div className="col-span-2">
          <label htmlFor="aboutCompany" className="block text-sm text-[#232323] font-lato">
            About Company
          </label>
          <textarea
            id="aboutCompany"
