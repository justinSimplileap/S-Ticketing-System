...
const ResetPasswordForm = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right Side: Form */}
      <div className="w-full md:w-1/2 flex flex-col items-center md:justify-center p-6 md:p-10 bg-white">
        <div className="block md:hidden mb-8">
          {/* Mobile logo */}
          <Image src={Simplileap} alt="Logo" />
        </div>
        <form className="max-w-md w-full" onSubmit={handleSubmit(onSubmit)}>
          <h2 className="text-2xl mb-8 text-center font-bold">
            Reset Password
          </h2>
          <div className="mb-4">
            <label
              htmlFor="newPassword"
              className="block text-gray-700 text-sm font-Plus Jakarta Sans mb-2"
            >
              New password*
            </label>
            <input
